...
def refinement_match_result(
    ...
    *,
    ...
    # A fully suppressed value ("*", "**", empty string, ...) should stay
    # compatible with any attacker value during phase 2. Otherwise, an attribute
    # that was mistakenly routed to refinement because its column is entirely "*"
    # can collapse the refined equivalence class to size 0.
